...
public class ScrollDemo extends JScrollPane
{
	...
	public ScrollDemo()
	{
		...
		discard[0].setBackground(new Color(100, 100, 33));
		discard[1].setBackground(new Color(254, 205, 200));
	...
	public void addToUndo(Tile t1, Tile t2)
	{
		...
		Dimension	size = new Dimension(++count * width, height);
		...
		Rectangle	r = new Rectangle(count * width, 0, width, height+20);
